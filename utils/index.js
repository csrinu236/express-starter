...
const attachCookieToResponse = ({ token, res }) => {
  ...
  res.cookie('token', token, {
    httpOnly: true,
    sameSite: 'strict', // to avoid csrf attacks using form post requests. cookie (attached by bank.api.com) going from cross domain (evil.com form post) will not go to the source bank.api.com.
